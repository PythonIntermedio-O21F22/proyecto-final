...
- **Semana 2 (16 dic.):**  Lectura de datos, visualización gráficas
- **Semana 4 (6 ene.):**   Implementación de métodos para widgets 1, 2, 3 y diseño de prototipo en QT Designer
...
- **Semana 6 (20 ene.):** Implementación de widgets 1, 2, 3, 4
- **Semana 8 (3 feb.):**  Implementación de widget 5, 6, pruebas, documentación, defensa de proyecto.
...
El repositorio debe actualizarse de forma continua, creando los commits necesarios. Su proyecto debe contener todos los archivos PYTHON necesarios para ejecutar su programa . Normalmente, tendría tres archivos: el archivo de la aplicación (.py), el archivo .ui con el diseño de la interfaz. Esto último es útil para asegurarse de que se revise su programa con los datos con los que lo probó, ya que se planea actualizar el archivo de datos regularmente a medida que avanza el tiempo. 
